 ...
 *
 * This header keeps the struct layout small and predictable so beginners can
 * follow how the telemetry payload is assembled.  The implementation focuses
 * on MISRA-C style clarity: explicit enum values, fixed-size structs, and
 * helper functions that return status codes instead of hiding side effects.
 */

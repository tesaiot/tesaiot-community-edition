...
## หลักการโอเพนซอร์สและการใช้แบรนด์

โค้ดเป็น Apache-2.0 ส่วน **ชื่อและเครื่องหมาย "TESAIoT"** สมาคมสมองกลฝังตัวไทย (TESA)
ดูแลไว้ *เพื่อทุกคนที่ไว้ใจชื่อนี้*

- [`PRINCIPLES.md`](PRINCIPLES.md) — ปฏิญญาโอเพนซอร์ส: อะไรฟรีตลอดไป เราปกป้องอะไรและทำไม รายได้นำไปทำอะไร
- [`TRADEMARK.md`](TRADEMARK.md) — แนวปฏิบัติการใช้ชื่อ/แบรนด์ (อะไรทำได้ทันที / อะไรควรทักมาคุยก่อน — คำตอบเกือบจะเป็น "ได้" เสมอ)
- [`ADOPTERS.md`](ADOPTERS.md) — ใช้ TESAIoT อยู่? ยินดีต้อนรับให้เพิ่มชื่อองค์กรของคุณ (ไม่บังคับ)
